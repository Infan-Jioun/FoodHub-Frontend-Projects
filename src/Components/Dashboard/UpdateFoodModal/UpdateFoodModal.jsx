  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosSecure.put(
        ...
        `/restaurant/${encodeURIComponent(restaurantName)}/food/${encodeURIComponent(food.foodName)}`,
        submitData
      );
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="flex flex-col items-center">
                <div
                  className={`relative w-full h-48 rounded-xl border-2 border-dashed ${isDragging ? 'border-[#ff1818] bg-red-50' :
            ...
            <div className="flex justify-end space-x-4 pt-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`px-5 py-2.5 rounded-lg text-white flex items-center ${loading ? 'bg-red-400' : 'bg-[#ff1818] hover:bg-[#ff1818]'
                  } transition`}
              >
                {loading ? (
                  <>
